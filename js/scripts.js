    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'b0e53b10c1f55ede516b240036b88f40'
            ...
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> Your invite code is incorrect.'));
             ...
             $.post('https://script.google.com/macros/s/AKfycbwzoj6S-mGYkDI6TTNGDC1N1-UHZ8_427QZkYbvddg5ex3aWf0j/exec', data)
                .done(function (data) {
                    console.log(data);
                ...
                .error(function(data) {
                    //handle 302 code (which is actually ok)
                    console.log(data);
                    $('#alert-wrapper').html('');
                    $('#rsvp-modal').modal('show');
                });
...
function initBBSRMap() {
    var la_fiesta = {lat: 59.9324054, lng: 30.2933424};
    var map = new google.maps.Map(document.getElementById('map-canvas'), {
        zoom: 15,
        center: la_fiesta,
        scrollwheel: false
